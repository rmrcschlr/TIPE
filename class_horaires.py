...
class Horaires :
    ...
    def changement_depart_terminus(self, indice_ligne, indice_terminus, indice_depart) :
        if indice_depart == 0 :
            ...
            return (self.departs_terminus[indice_ligne][indice_terminus][0] < depart + marge1 and self.departs_terminus[indice_ligne][indice_terminus][0] < self.departs_terminus[indice_ligne][indice_terminus][1] - cadencement + marge2, self.departs_terminus[indice_ligne][indice_terminus][0] > depart and self.departs_terminus[indice_ligne][indice_terminus][0] > self.departs_terminus[indice_ligne][indice_terminus][1] - cadencement - marge2)
        elif indice_depart == len(self.departs_terminus[indice_ligne][indice_terminus]) - 1 :
            cadencement, marge = CADENCEMENTS.prochain_depart(indice_ligne, self.departs_terminus[indice_ligne][indice_terminus][indice_depart - 1])
            return (self.departs_terminus[indice_ligne][indice_terminus][indice_depart] < self.departs_terminus[indice_ligne][indice_terminus][indice_depart - 1] + cadencement + marge, self.departs_terminus[indice_ligne][indice_terminus][indice_depart] > self.departs_terminus[indice_ligne][indice_terminus][indice_depart - 1] + cadencement - marge)
        else :
            ...
            return (self.departs_terminus[indice_ligne][indice_terminus][indice_depart] < self.departs_terminus[indice_ligne][indice_terminus][indice_depart - 1] + cadencement1 + marge1 and self.departs_terminus[indice_ligne][indice_terminus][indice_depart] < self.departs_terminus[indice_ligne][indice_terminus][indice_depart + 1] - cadencement2 + marge2, self.departs_terminus[indice_ligne][indice_terminus][indice_depart] > self.departs_terminus[indice_ligne][indice_terminus][indice_depart - 1] + cadencement1 - marge1 and self.departs_terminus[indice_ligne][indice_terminus][indice_depart] > self.departs_terminus[indice_ligne][indice_terminus][indice_depart + 1] - cadencement2 - marge2)
